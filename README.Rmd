...
[![Codecov test coverage](https://codecov.io/gh/adamwaring/dataviewer/branch/master/graph/badge.svg)](https://codecov.io/gh/adamwaring/dataviewer?branch=master)
<!-- badges: end -->
...
The available datasets are listed in a table with some summary information. 
These can be deleted by selecting the delete button. 

![Argon table showing available datasets](inst/app/www/argon_table_example.PNG)
